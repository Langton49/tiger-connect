...
export default function Search() {
  ...
  const getSellerName = (sellerId: string) => {
    ...
    return seller ? seller.first_name + " " + seller.last_name : "Unknown User";
  };
                        ...
                        <div className="flex items-start gap-4">
                          <div className="w-16 h-16 shrink-0">
                            <img
                              src={
                                isMarketplaceItem
                                  ? (item as MarketplaceItem).images[0]
                                  : (item as Service).images
                              }
                              alt={item.title}
                            ...
                            <div className="flex justify-between items-center mt-2">
                              <div>
                                {isMarketplaceItem ? (
                                  ...
                                  <div className="flex items-center">
                                    <span className="font-semibold">
                                      ${(item as Service).rate}
                                    </span>
                                    {(item as Service).rateType ===
                                      "hourly" && (
                              ...
                              <div className="flex items-center">
                                <span className="text-xs text-gray-500">
                                  {getSellerName(
                                    isMarketplaceItem
                                      ? (item as MarketplaceItem).seller_id
                                      : (item as Service).provider_id
                                  )}
                                </span>
                                <Link
                                  to={`/messages/${
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex justify-between items-center mt-2">
                            ...
                            <div className="flex items-center">
                              ...
                              <Link
                                to={`/messages/${service.provider_id}`}
                                className="ml-2"
                              >
                                <MessageCircle className="w-4 h-4 text-grambling-gold hover:text-grambling-gold/80" />
                              </Link>
        ...
        {!searchQuery && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 max-w-md mx-auto">
              Enter a search term above to find marketplace items, services, and
              more.
            </p>
          </div>
        )}
